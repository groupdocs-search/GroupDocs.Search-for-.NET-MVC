...
using GroupDocs.Search.MVC.Products.Common.Resources;
using System;
...
using GroupDocs.Search.MVC.Products.Common.Util.Comparator;
using GroupDocs.Search.MVC.Products.Search.Entity.Web;
using GroupDocs.Search.MVC.Products.Search.Service;
using GroupDocs.Search.MVC.Products.Search.Entity.Web.Request;

namespace GroupDocs.Search.MVC.Products.Search.Controllers
{
    /// <summary>
    /// SearchApiController
    /// </summary>
